...
import io.basc.framework.beans.repository.RepositoryBeanDefinition;
...
@Provider
public class DataBaseBeanFactoryPostProcessor implements
	...
	public void postProcessBeanFactory(ConfigurableBeanFactory beanFactory)
		...
		if (!beanFactory.containsDefinition(Configurable.class.getName())) {
			beanFactory.registerDefinition(new ConfigurableDefinition(
					beanFactory));
		}

		if (beanFactory.containsDefinition(Repository.class.getName())) {
			beanFactory.registerDefinition(new RepositoryBeanDefinition(
					beanFactory, Repository.class, DB.class.getName()));
		}
	}
