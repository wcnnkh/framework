...
import io.basc.framework.web.apache.multipart.MultipartStream.ItemInputStream;
...
public class ApacheFileUpload {
     ...
     */
    public ApacheFileUpload(FileItemFactory fileItemFactory) {
    ...
    protected FileItem createItem(Map<String, String> headers,
                                  boolean isFormField)
        throws FileUploadException {
        return fileItemFactory.createItem(getFieldName(headers),
     ...
     * {@link ApacheFileUpload#getItemIterator(RequestContext)}.
     */
