...
public class SSLContexts {
	 ...
	 * ({@code cacerts} file in the security properties directory). System
	 ...
	 * Please note that {@code Default} algorithm is supported as of Java 6. This
	 * method will fall back onto {@link #createDefault()} when {@code Default}
