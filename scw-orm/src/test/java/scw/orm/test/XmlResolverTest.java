...
public class XmlResolverTest {
	...
	public void test() {
		...
		Map<String, TestBean> map = (Map<String, TestBean>) SystemEnvironment.getInstance().getResourceResolver().resolveResource(resource,
				mapType);
		System.out.println(map);
		List<TestBean> list = (List<TestBean>) SystemEnvironment.getInstance().getResourceResolver().resolveResource(resource, listType);
		...
		Map<String, Map<String, TestBean>> map2 = (Map<String, Map<String, TestBean>>) SystemEnvironment.getInstance().getResourceResolver().resolveResource(resource,
				mapType2);
