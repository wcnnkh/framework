...
public interface JsonDeserializer<T> {
   ...
   * {@link JsonDeserializationContext#deserialize(GsonJsonElement, Type)} method to create objects
   ...
   */
  public T deserialize(GsonJsonElement json, Type typeOfT, JsonDeserializationContext context)
      throws JsonParseException;
}
