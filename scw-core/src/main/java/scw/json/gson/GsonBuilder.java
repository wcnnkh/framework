...
import static scw.json.gson.Gson.DEFAULT_COMPLEX_MAP_KEYS;
import static scw.json.gson.Gson.DEFAULT_ESCAPE_HTML;
import static scw.json.gson.Gson.DEFAULT_JSON_NON_EXECUTABLE;
import static scw.json.gson.Gson.DEFAULT_LENIENT;
import static scw.json.gson.Gson.DEFAULT_PRETTY_PRINT;
import static scw.json.gson.Gson.DEFAULT_SERIALIZE_NULLS;
import static scw.json.gson.Gson.DEFAULT_SPECIALIZE_FLOAT_VALUES;
...
import scw.json.gson.internal.bind.TreeTypeAdapter;
...
public final class GsonBuilder {
   ...
   * that do not have the {@link scw.json.gson.annotations.Expose} annotation.
   *
   * @return a reference to this {@code GsonBuilder} object to fulfill the "Builder" pattern
   */
