...
public class CharsetCodec implements BytesCodec<String> {
	...
	public static final CharsetCodec ISO_8859_1 = new CharsetCodec(
			Constants.ISO_8859_1);

	public static final CharsetCodec US_ASCII = new CharsetCodec(
			Constants.US_ASCII);
	...
	public Encoder<String, String> toHmacMD5(String secretKey) {
		return toEncoder(new HmacMD5(encode(secretKey))
				.toEncoder(HexCodec.DEFAULT));
	}

	public Encoder<String, String> toHmacSHA1(String secretKey) {
		return toEncoder(new HmacSHA1(encode(secretKey))
				.toEncoder(HexCodec.DEFAULT));
	}
