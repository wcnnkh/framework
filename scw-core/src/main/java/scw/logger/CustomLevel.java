...
public class CustomLevel extends Level {
	...
	public static final CustomLevel TRACE = new CustomLevel("TRACE", java.util.logging.Level.FINER.intValue(), java.util.logging.Level.FINE.getResourceBundleName());
	public static final CustomLevel DEBUG = new CustomLevel("DEBUG", java.util.logging.Level.FINE.intValue(), java.util.logging.Level.CONFIG.getResourceBundleName());
