...
public class ConvertibleValueFactoryWrapper<K> implements ConvertibleValueFactory<K> {
	private final ConvertibleValueFactory<K> target;

	public ConvertibleValueFactoryWrapper(ConvertibleValueFactory<K> target) {
		this.target = target;
	}
