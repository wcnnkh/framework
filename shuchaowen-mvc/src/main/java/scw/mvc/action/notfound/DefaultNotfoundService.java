...
public class DefaultNotfoundService implements NotFoundService {
	...
	public Object notfound(Channel channel, FilterChain filterChain) throws Throwable {
		...
		if (channel instanceof Channel) {
			return httpNotfound((Channel) channel, filterChain);
		}
	...
	protected Object httpNotfound(Channel channel, FilterChain filterChain) throws Throwable {
		channel.getResponse().sendError(404, "not found action");
		return null;
	}
}
