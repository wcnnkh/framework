...
import io.basc.framework.data.storage.StorageWrapper;
import io.basc.framework.util.CollectionUtils;

public interface CasStorageWrapper<K>
		extends CasStorage<K>, StorageWrapper<K>, CasKeyOperationsWrapper<K>, CasValueOperationsWrapper<K, Object> {
	@Override
	CasStorage<K> getSourceOperations();
