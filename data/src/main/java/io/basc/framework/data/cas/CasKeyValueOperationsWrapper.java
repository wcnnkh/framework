...
public interface CasKeyValueOperationsWrapper<K, V> extends CasKeyValueOperations<K, V>,
		KeyValueOperationsWrapper<K, V>, CasKeyOperationsWrapper<K>, CasValueOperationsWrapper<K, V> {
	CasKeyValueOperations<K, V> getSourceOperations();
