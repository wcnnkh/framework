 ...
 *
 * <p>
 * A text may contain {@code $ ...}} placeholders, to be resolved as servlet
 * context init parameters or system properties: e.g. {@code $ user.dir}}.
...
public abstract class ServletContextPropertyUtils {
	 ...
	 * corresponding servlet context init parameter or system property values.
	 * 
	 * @param text
	 ...
	 * through unchanged if the flag is set to true.
	 * 
	 * @param text
	 *            the String to resolve
	 * @param servletContext
	...
	public static String resolvePlaceholders(String text,
		...
		PropertyPlaceholderHelper helper = (ignoreUnresolvablePlaceholders ? SystemPropertyUtils.nonStrictHelper
				: SystemPropertyUtils.strictHelper);
		return helper.replacePlaceholders(text,
				new ServletContextPlaceholderResolver(text, servletContext));
	}

	private static class ServletContextPlaceholderResolver implements
		...
		public ServletContextPlaceholderResolver(String text,
				ServletContext servletContext) {
			this.text = text;
		...
		public String resolvePlaceholder(String placeholderName) {
			try {
				String propVal = this.servletContext
