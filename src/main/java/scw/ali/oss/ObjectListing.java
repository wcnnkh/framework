...
public final class ObjectListing implements Serializable{
     ...
     */
    private List<scw.ali.oss.OSSObjectSummary> objectSummaries = new ArrayList<scw.ali.oss.OSSObjectSummary>();
    ...
    public ObjectListing(com.aliyun.oss.model.ObjectListing objectListing){
    	if(objectListing.getObjectSummaries() != null){
    		for(OSSObjectSummary ossObjectSummary : objectListing.getObjectSummaries()){
    			...
    			objectSummaries.add(new scw.ali.oss.OSSObjectSummary(ossObjectSummary));
    		}
    	}
    ...
    public List<scw.ali.oss.OSSObjectSummary> getObjectSummaries() {
		return objectSummaries;
	}

	public void setObjectSummaries(List<scw.ali.oss.OSSObjectSummary> objectSummaries) {
