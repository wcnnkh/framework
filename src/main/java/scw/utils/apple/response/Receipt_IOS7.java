 ...
 *
 */
public class Receipt_IOS7 {
	private String original_purchase_data_pst;
	private long purchase_data_ms;
	...
	private String purchase_dta_pst;
	private String bid;
	...
	public long getPurchase_data_ms() {
		return purchase_data_ms;
	}

	public void setPurchase_data_ms(long purchase_data_ms) {
		this.purchase_data_ms = purchase_data_ms;
	}
	...
	public String getPurchase_dta_pst() {
		return purchase_dta_pst;
	}

	public void setPurchase_dta_pst(String purchase_dta_pst) {
		this.purchase_dta_pst = purchase_dta_pst;
	}
