...
import scw.net.http.entity.file.File;
import scw.net.http.entity.parameter.AbstractMultipartParameter;
import scw.net.http.entity.parameter.FieldMultipartParameter;
import scw.net.http.entity.parameter.FileMultipartParameter;
