...
public abstract class DefaultTransactionUtils {
	...
	public static void transactionSynchronization(TransactionSynchronization ts)
	...
	public static void commit(MultipleConnectionTransactionSynchronization mcts)
			throws TransactionException {
		LinkedList<MultipleConnectionTransactionSynchronization> list = LOCAL
				.get();
		if (list == null) {
		...
		MultipleConnectionTransactionSynchronization currentMcts = list
				.getLast();
		if (mcts != currentMcts) {
