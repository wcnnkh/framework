...
public final class ObjectListing implements Serializable{
     ...
     */
    private List<shuchaowen.ali.oss.OSSObjectSummary> objectSummaries = new ArrayList<shuchaowen.ali.oss.OSSObjectSummary>();
    ...
    public ObjectListing(com.aliyun.oss.model.ObjectListing objectListing){
    	if(objectListing.getObjectSummaries() != null){
    		for(OSSObjectSummary ossObjectSummary : objectListing.getObjectSummaries()){
    			...
    			objectSummaries.add(new shuchaowen.ali.oss.OSSObjectSummary(ossObjectSummary));
    		}
    	}
    ...
    public List<shuchaowen.ali.oss.OSSObjectSummary> getObjectSummaries() {
		return objectSummaries;
	}

	public void setObjectSummaries(List<shuchaowen.ali.oss.OSSObjectSummary> objectSummaries) {
