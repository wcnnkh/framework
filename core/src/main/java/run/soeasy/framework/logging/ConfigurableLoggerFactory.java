 ...
 *   <li>SPI支持：通过{@link #configure(ProviderFactory)}自动发现日志工厂实现</li>
 * </ul>
 * 
 * <p><b>线程安全说明：</b>
 * <ul>
...
public class ConfigurableLoggerFactory extends LoggerRegistry implements Configurable {
     ...
     * 设置日志工厂并触发重加载。
     * <p>
     * 同步更新日志工厂引用，并调用{@link #reload()}更新所有日志器，
     * 确保配置变更立即生效。
     * 
     ...
     * <p>
     * 从提供者工厂获取LoggerFactory实例，存在时设置为当前工厂，
     * 支持通过SPI机制自动发现日志工厂实现。
     * 
