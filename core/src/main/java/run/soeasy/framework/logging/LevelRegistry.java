...
/**
 * 日志级别注册表，实现{@link LevelFactory}和{@link Reloadable}接口，
 * 提供日志级别配置的管理、匹配和动态加载功能，支持按名称规则批量设置日志级别。
 * 
 * <p><b>核心特性：</b>
 * <ul>
 *   <li>级别管理：存储和管理日志级别配置，支持按名称匹配</li>
 *   <li>动态加载：实现Reloadable接口，支持配置重新加载</li>
