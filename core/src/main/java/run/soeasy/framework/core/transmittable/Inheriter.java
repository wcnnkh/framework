...
public interface Inheriter<A, B> {
	...
	public static class WrappedCallable<A, B, I extends Inheriter<A, B>, T, E extends Throwable, W extends run.soeasy.framework.core.function.Callable<? extends T, ? extends E>>
			extends Wrapper<A, B, I, W> implements run.soeasy.framework.core.function.Callable<T, E> {
	...
	public static class WrappedConsumer<A, B, I extends Inheriter<A, B>, S, E extends Throwable, W extends run.soeasy.framework.core.function.Consumer<? super S, ? extends E>>
			extends Wrapper<A, B, I, W> implements run.soeasy.framework.core.function.Consumer<S, E> {
	...
	public static class WrappedFunction<A, B, I extends Inheriter<A, B>, S, T, E extends Throwable, W extends run.soeasy.framework.core.function.Function<? super S, ? extends T, ? extends E>>
			extends Wrapper<A, B, I, W> implements run.soeasy.framework.core.function.Function<S, T, E> {
	...
	public static class WrappedRunnable<A, B, I extends Inheriter<A, B>, E extends Throwable, W extends run.soeasy.framework.core.function.Runnable<? extends E>>
			extends Wrapper<A, B, I, W> implements run.soeasy.framework.core.function.Runnable<E> {
	...
	default <T, E extends Throwable> run.soeasy.framework.core.function.Callable<T, E> wrapCallable(
			@NonNull run.soeasy.framework.core.function.Callable<? extends T, ? extends E> callable) {
	...
	default <S, E extends Throwable> run.soeasy.framework.core.function.Consumer<S, E> wrapConsumer(
			@NonNull run.soeasy.framework.core.function.Consumer<? super S, ? extends E> consumer) {
	...
	default <S, T, E extends Throwable> run.soeasy.framework.core.function.Function<S, T, E> wrapFunction(
			@NonNull run.soeasy.framework.core.function.Function<? super S, ? extends T, ? extends E> function) {
		return new WrappedFunction<>(function, this);
	}

	default <E extends Throwable> run.soeasy.framework.core.function.Runnable<E> wrapRunnable(
			run.soeasy.framework.core.function.Runnable<? extends E> runnable) {
