...
/**
 * 可执行元素异常类型描述符提供者，实现{@link Streamable}接口，
...
public class ExecutableExceptionTypeDescriptors implements Streamable<TypeDescriptor> {
    /**
    ...
    @Override
    public Streamable<TypeDescriptor> reload() {
    	return new ExecutableExceptionTypeDescriptors(executable);
    }
    ...
    public Stream<TypeDescriptor> stream() {
    	...
    	return Stream.of(typeDescriptors);
    }
}