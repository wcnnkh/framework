 ...
 * 提供注解属性映射的基础实现，包括hashCode和equals方法的默认实现， 是框架中构建具体注解属性映射器的抽象基类。
 * <p>
...
public abstract class AbstractAnnotationPropertyMapping<A extends Annotation> implements AnnotationProperties<A> {
	...
	@Override
	public int hashCode() {
		return getType().hashCode() + ArrayUtils.hashCode(elements().toArray());
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof AnnotationProperties) {
			...
			return getType() == annotationProperties.getType()
					&& equalsInAnyOrder(annotationProperties, (a, b) -> ObjectUtils.equals(a.getKey(), b.getKey())
