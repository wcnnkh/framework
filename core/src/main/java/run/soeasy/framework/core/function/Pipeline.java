...
import run.soeasy.framework.core.function.Function.FunctionPipeline;
...
public interface Pipeline<T, E extends Throwable> extends Supplier<T, E> {
	...
	public static class PipelineOptional<S, T, E extends Throwable>
		...
		public <R, X extends Throwable> R apply(
				run.soeasy.framework.core.function.Function<? super T, ? extends R, ? extends X> mapper) throws E, X {
			try {
				T value = super.get();
