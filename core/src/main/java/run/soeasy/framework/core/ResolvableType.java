...
import run.soeasy.framework.core.SerializableTypeWrapper.FieldTypeProvider;
import run.soeasy.framework.core.SerializableTypeWrapper.MethodParameterTypeProvider;
import run.soeasy.framework.core.SerializableTypeWrapper.TypeProvider;
 ...
 * </pre>
 *
 * @author https://github.com/spring-projects/spring-framework/blob/main/spring-core/src/main/java/org/springframework/core/ResolvableType.java
 * @see #forField(Field)
...
public class ResolvableType implements Serializable {
	 ...
	 * @see #forMethodParameter(Method, int)
	 */
	static ResolvableType forMethodParameter(MethodParameter methodParameter,  Type targetType,
			int nestingLevel) {
	...
	private static class TypeVariablesVariableResolver implements VariableResolver {
		...
		public ResolvableType resolveVariable(TypeVariable<?> variable) {
			...
			for (int i = 0; i < this.variables.length; i++) {
				...
				if (ObjectUtils.equals(resolvedVariable, variableToCompare)) {
