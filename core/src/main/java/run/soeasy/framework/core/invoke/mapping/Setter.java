...
import run.soeasy.framework.core.invoke.ExecutableDescriptor.ExecutableDescriptorWrapper;
import run.soeasy.framework.core.invoke.ExecutableDescriptor.RenamedExecutable;
import run.soeasy.framework.core.transform.mapping.ParameterDescriptor;

public interface Setter extends ExecutableDescriptor, PropertyDescriptor {
	...
	public static interface SetterWrapper<W extends Setter>
			extends Setter, ExecutableDescriptorWrapper<W>, PropertyDescriptorWrapper<W> {
		@Override
	...
	@Override
	default Elements<? extends ParameterDescriptor> getParameterDescriptors() {
