 ...
 * {@link run.soeasy.framework.core.type.AnnotationMetadata} implementations.
 *
 * <p>
...
public class AnnotationAttributes extends LinkedHashMap<String, Object> {
	 ...
	 */
	public AnnotationAttributes(@NonNull String annotationType, ClassLoader classLoader) {
		Assert.notNull(annotationType, "'annotationType' must not be null");
