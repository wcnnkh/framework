 ...
 * @see ArrayMapper 对比类，适用于一对一的集合同步场景
 */
@Getter
@Setter
public class MapMapper<K, V extends TypedValueAccessor, T extends Mapping<K, V>> extends FilterableMapper<K, V, T> {
	/**
	 ...
	 */
	public MapMapper(@NonNull Iterable<MappingFilter<K, V, T>> filters) {
		super(filters);
	}
	 ...
	 */
	public MapMapper(@NonNull Iterable<MappingFilter<K, V, T>> filters, Mapper<K, V, T> mapper) {
