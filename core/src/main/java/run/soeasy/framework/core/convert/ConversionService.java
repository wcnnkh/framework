 ...
 * 支持动态注册转换器，并通过{@link ServiceInjectors}实现转换器的依赖注入， 是框架类型转换体系的核心枢纽。
 *
 * <p>
 * <b>核心特性：</b>
 * <ul>
...
public class ConversionService implements Converter {
	 ...
	 * <p>
	 * 注册一个服务注入器，当注入的服务实现{@link ConverterAware}接口时， 自动为其设置当前转换服务实例，实现转换器与转换服务的关联。
	 */
	public ConversionService() {
		...
		converters.getInjectors().register(injectors);
