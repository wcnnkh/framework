...
interface AnnotationsProcessor<C, R> {
	 ...
	 */
	default R doWithAggregate(@NonNull C context, int aggregateIndex) {
		return null;
	}
	 ...
	 * @return a {@code non-null} result if no further processing is required
	 */
	R doWithAnnotations(@NonNull C context, int aggregateIndex, Object source, Annotation[] annotations);
