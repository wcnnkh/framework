 ...
 * 针对特定目标对象的属性访问器（{@link ObjectPropertyAccessor}）， 从而实现对对象属性的统一访问和操作。
 *
 * <p>
 * <b>核心特性：</b>
 * <ul>
 ...
 * <li>{@code T}：属性模板类型，需实现{@link PropertyMapping}</li>
 * </ul>
 *
 * <p>
 * <b>使用场景：</b>
...
public class ObjectMapping<S extends Property, T extends PropertyMapping<S>>
	...
	public ObjectMapping(@NonNull T template, Object target) {
		super(template.elements().map((e) -> new ObjectPropertyAccessor<>(e, target)));
	}
}