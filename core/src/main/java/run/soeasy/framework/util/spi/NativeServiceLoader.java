...
public class NativeServiceLoader<S> implements run.soeasy.framework.util.collections.ServiceLoader<S> {
	/**
	 ...
	 */
	public static <S> run.soeasy.framework.util.collections.ServiceLoader<S> load(Class<S> service) {
	 ...
	 * @return A new service loader
	 */
	public static <S> run.soeasy.framework.util.collections.ServiceLoader<S> load(Class<S> service, ClassLoader loader) {
	 ...
	 * @return A new service loader
	 */
	public static <S> run.soeasy.framework.util.collections.ServiceLoader<S> loadInstalled(Class<S> service) {
