...
public final class Functions {
	public static class FinalSupplier<T>
			extends run.soeasy.framework.util.function.Supplier.FinalSupplier<T, RuntimeException> implements Supplier<T> {
	...
	public static class ToCallable<T, E extends Exception, W extends run.soeasy.framework.util.function.Callable<? extends T, ? extends E>>
	...
	public static class ToFunction<S, T, E extends RuntimeException, W extends run.soeasy.framework.util.function.Function<? super S, ? extends T, ? extends E>>
	...
	public static class ToPredicate<T, E extends RuntimeException, W extends run.soeasy.framework.util.function.Predicate<? super T, ? extends E>>
	...
	public static class ToRunnable<E extends RuntimeException, W extends run.soeasy.framework.util.function.Runnable<? extends E>>
	...
	public static class ToSupplier<T, E extends RuntimeException, W extends run.soeasy.framework.util.function.Supplier<? extends T, ? extends E>>
	...
	public static <T, E extends RuntimeException> Predicate<T> toPredicate(
			@NonNull run.soeasy.framework.util.function.Predicate<? super T, ? extends E> predicate) {
	...
	public static <T, E extends RuntimeException> Supplier<T> toSupplier(
			@NonNull run.soeasy.framework.util.function.Supplier<? extends T, ? extends E> supplier) {
