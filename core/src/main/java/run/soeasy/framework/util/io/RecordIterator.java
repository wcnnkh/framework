...
public final class RecordIterator<E> implements CloseableIterator<E> {
	private final run.soeasy.framework.util.function.Supplier<? extends InputStream, ? extends IOException> source;
	...
	public RecordIterator(run.soeasy.framework.util.function.Supplier<? extends InputStream, ? extends IOException> source, RecordCodec<E> codec) {
