...
import run.soeasy.framework.util.SystemUtils;
...
import run.soeasy.framework.util.io.VfsResource;
 ...
 * {@link run.soeasy.framework.util.io.Resource}, or alternatively may contain the
 * special "{@code classpath*:}" prefix and/or internal Ant-style regular
 * expressions (matched using
 * {@link run.soeasy.framework.util.match.AntPathMatcher} utility). Both of the
 ...
 * @see run.soeasy.framework.util.match.AntPathMatcher
 * @see run.soeasy.framework.util.io.load.ResourceLoader#getResource(String)
...
public class PathMatchingResourcePatternResolver implements ResourcePatternResolver {
	...
	protected void addAllRsrcResources(String path, Collection<Resource> resources) throws IOException {
		for (CharSequenceTemplate template : SystemUtils.getClassPath().getAsElements()) {
			...
			Resource resource = ResourceUtils.isJarFileURL(fileSystemResource.getURL())
					? new UrlResource(ResourceUtils.JAR_URL_PREFIX + fileSystemResource.getURL()
	 ...
	 * @see java.lang.ClassLoader#getResources
	 * @see run.soeasy.framework.util.io.Resource
	 */
	 ...
	 * @see run.soeasy.framework.util.match.PathMatcher
	 */
	protected Resource[] findPathMatchingResources(String locationPattern) throws IOException {
		...
		for (Resource rootDirResource : rootDirResources) {
			...
			if (equinoxResolveMethod != null && rootDirUrl.getProtocol().startsWith("bundle")) {
				URL resolvedUrl = (URL) ReflectionUtils.invoke(equinoxResolveMethod, null, rootDirUrl);
				if (resolvedUrl != null) {
	 ...
	 * @see #doFindPathMatchingJarResources
	 * @see run.soeasy.framework.util.io.ResourceUtils#isJarURL
	 */
