...
public interface Aop extends AopPolicy, ProxyFactory {
	...
	<T> Proxy getProxy(Class<? extends T> clazz, Supplier<? extends T> instanceSupplier, Class<?>[] interfaces,
			@Nullable MethodInterceptor methodInterceptor);

	<T> Proxy getProxy(Class<? extends T> clazz, Supplier<? extends T> instanceSupplier);

	<T> Proxy getProxy(Class<? extends T> clazz, T instance, Class<?>[] interfaces,
			@Nullable MethodInterceptor methodInterceptor);

	<T> Proxy getProxy(Class<? extends T> clazz, T instance);

	<T> MethodInvoker getProxyMethod(Class<? extends T> targetClass, Supplier<? extends T> instanceSupplier,
			Method method, @Nullable MethodInterceptor methodInterceptor);
