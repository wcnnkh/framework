 ...
 *
 * @author https://github.com/spring-projects/spring-framework/blob/main/spring-core/src/main/java/org/springframework/core/annotation/MergedAnnotation.java
...
public interface MergedAnnotation<A extends Annotation> {
	 ...
	 * and not one that is {@linkplain #isMetaPresent() meta-present} or
	 ...
	 * not {@linkplain #isMetaPresent() meta-present}.
	 * <p>
	...
	/**
	 * Create a type-safe synthesized version of this merged annotation that can be
	 ...
	 * <em>synthesizable</em>. An annotation is considered synthesizable if one of
