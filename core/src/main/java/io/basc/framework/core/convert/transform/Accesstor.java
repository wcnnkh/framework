...
public interface Accesstor extends Value, AccessDescriptor {
	@FunctionalInterface
	public static interface AccessWrapper<W extends Accesstor>
			extends Accesstor, ValueWrapper<W>, AccessDescriptorWrapper<W> {
	...
	public static class SharedAccess<W extends AccessDescriptor> extends SharedValue<W>
			implements Accesstor, AccessDescriptorWrapper<W> {
	 ...
	 * @return
	 */
	public static Accesstor create(Value value) {
	 ...
	 * @return
	 */
	public static Accesstor of(Value value) {
		if (value instanceof Accesstor) {
			return (Accesstor) value;
		}
		return create(value);
	}

	public static class StandardAccess<W extends Value> implements Accesstor, ValueWrapper<W> {
