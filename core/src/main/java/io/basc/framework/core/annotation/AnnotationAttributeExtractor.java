...
interface AnnotationAttributeExtractor<S> {
	...
	/**
	 * Get the element that is annotated with an annotation of the annotation type
	 ...
	 * 
	 * @param attributeMethod an attribute method from the annotation type supported
	 *                        by this extractor
