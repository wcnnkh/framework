...
public abstract class AbstractExecutors<T extends Executor> implements Executors<T> {
	...
	@Override
	public boolean canExecuted(@NonNull Parameters parameters) {
		// TODO Auto-generated method stub
		return Executors.super.canExecuted(parameters);
	}

	@Override
	public Value execute(@NonNull Parameters parameters) throws Throwable {
		// TODO Auto-generated method stub
		return Executors.super.execute(parameters);
	}
}
