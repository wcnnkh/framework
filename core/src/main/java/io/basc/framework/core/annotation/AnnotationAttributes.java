...
public class AnnotationAttributes extends LinkedHashMap<String, Object> {
	...
	/**
	 * Get the value stored under the specified {@code attributeName} as a string,
	 * taking into account alias semantics defined via {@link AliasFor @AliasFor}.
	 * <p>
	 * If there is no value stored under the specified {@code attributeName} but the
	 * attribute has an alias declared via {@code @AliasFor}, the value of the alias
	 * will be returned.
	 * 
	 * @param attributeName    the name of the attribute to get; never {@code null}
	 *                         or empty
	 * @param annotationType   the type of annotation represented by this
	 *                         {@code AnnotationAttributes} instance; never
	 *                         {@code null}
	 * @param annotationSource the source of the annotation represented by this
	 *                         {@code AnnotationAttributes} (e.g., the
	 *                         {@link AnnotatedElement}); or {@code null} if unknown
	 * @return the string value
	 * @throws IllegalArgumentException         if the attribute and its alias do
	 *                                          not exist or are not of type
	 *                                          {@code String}
	 * @throws AnnotationConfigurationException if the attribute and its alias are
	 *                                          both present with different
	 *                                          non-empty values
	 */
	...
	/**
	 * Get the value stored under the specified {@code attributeName} as an array of
	 * strings, taking into account alias semantics defined via
	...
	/**
	 * Get the value stored under the specified {@code attributeName} as an array of
	 * classes, taking into account alias semantics defined via
	 * {@link AliasFor @AliasFor}.
	 * <p>
	 * If there is no value stored under the specified {@code attributeName} but the
	 * attribute has an alias declared via {@code @AliasFor}, the value of the alias
	...
	/**
	 * Get the value stored under the specified {@code attributeName} as an object
	 * of the {@code expectedType}, taking into account alias semantics defined via
	 * {@link AliasFor @AliasFor}.
	 * <p>
	 * If there is no value stored under the specified {@code attributeName} but the
	 * attribute has an alias declared via {@code @AliasFor}, the value of the alias
	...
	private <T> T getRequiredAttributeWithAlias(String attributeName, Class<? extends Annotation> annotationType,
		...
		if (aliasNames != null) {
			for (String aliasName : aliasNames) {
				...
				if (!attributeEmpty && !aliasEmpty && !ObjectUtils.equals(attributeValue, aliasValue)) {
	 ...
	 * @param expectedType  the expected type; never {@code null}
	 * @return the value
	 * @throws IllegalArgumentException if the attribute is not of the expected type
	...
	/**
	 * Store the supplied {@code value} in this map under the specified {@code key},
	 * unless a value is already stored under the key.
	 * 
	 * @param key   the key under which to store the value
	 * @param value the value to store
	 * @return the current value stored in this map, or {@code null} if no value was
	 *         previously stored in this map
	 * @see #get
	 * @see #put
	 */
	@Override
