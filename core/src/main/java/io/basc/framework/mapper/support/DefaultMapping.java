...
@Data
public class DefaultMapping<T extends Element> implements Mapping<T> {
	private String name;
	...
	public <S extends Element> DefaultMapping(Mapping<? extends S> mapping, Function<? super S, ? extends T> converter) {
