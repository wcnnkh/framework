...
public class MapProcessDecorator<S, T, E extends Throwable> implements
		Processor<S, T, E> {
	private final Mapper<S, ? extends E> mapper;
	private final Processor<S, ? extends T, ? extends E> processor;
	private final Class<? extends T> type;

	public MapProcessDecorator(Mapper<S, ? extends E> mapper,
			Processor<S, ? extends T, ? extends E> processor, Class<? extends T> type) {
		this.mapper = mapper;
