...
public class SimpleTitles extends ItemRegistry<StandardItem> {
	 ...
	 * @return
	 */
	public SimpleTitles setTitle(int index, String name, @Nullable Elements<String> aliasNames) {
		// 先删除所有相关的标题
	 ...
	 * @return
	 */
	public SimpleTitles addTitle(String name, @Nullable Elements<String> aliasNames) {
		StandardItem item = new StandardItem();
