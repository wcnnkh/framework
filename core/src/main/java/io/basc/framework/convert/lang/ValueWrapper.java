...
public interface ValueWrapper extends Value, Optional<ValueWrapper>, Wrapper<Object> {
	...
	static ValueWrapper of(@Nullable Object value) {
		return of(value, null);
	}

	static ValueWrapper of(@Nullable Object value, @Nullable TypeDescriptor type) {
	...
	default BigDecimal getAsBigDecimal() {
		...
		if (value instanceof ValueWrapper) {
			return ((ValueWrapper) value).getAsBigDecimal();
		}
	...
	default BigInteger getAsBigInteger() {
		...
		if (value instanceof ValueWrapper) {
			return ((ValueWrapper) value).getAsBigInteger();
		}
	...
	default boolean getAsBoolean() {
		...
		if (value instanceof ValueWrapper) {
			return ((ValueWrapper) value).getAsBoolean();
		}
	...
	default byte getAsByte() {
		...
		if (value instanceof ValueWrapper) {
			return ((ValueWrapper) value).getAsByte();
		}
	...
	default char getAsChar() {
		...
		if (value instanceof ValueWrapper) {
			return ((ValueWrapper) value).getAsChar();
		}
	...
	default double getAsDouble() {
		...
		if (value instanceof ValueWrapper) {
			return ((ValueWrapper) value).getAsDouble();
		}
	...
	default <T extends Enum<T>> T getAsEnum(Class<T> enumType) {
		...
		if (value instanceof ValueWrapper) {
			return ((ValueWrapper) value).getAsEnum(enumType);
		}
	...
	default int getAsInt() {
		...
		if (value instanceof ValueWrapper) {
			return ((ValueWrapper) value).getAsInt();
		}
	...
	default long getAsLong() {
		...
		if (value instanceof ValueWrapper) {
			return ((ValueWrapper) value).getAsLong();
		}
	...
	default Number getAsNumber() {
		...
		if (value instanceof ValueWrapper) {
			return ((ValueWrapper) value).getAsNumber();
		}
	...
	default Object getAsObject(TypeDescriptor type) {
		if (ValueWrapper.isBaseType(type.getType())) {
	...
	default short getAsShort() {
		...
		if (value instanceof ValueWrapper) {
			return ((ValueWrapper) value).getAsShort();
		}
	...
	default String getAsString() {
		...
		if (value instanceof ValueWrapper) {
			return ((ValueWrapper) value).getAsString();
		}
	...
	default boolean isNumber() {
		...
		if (value instanceof ValueWrapper) {
			return ((ValueWrapper) value).isNumber();
		}
