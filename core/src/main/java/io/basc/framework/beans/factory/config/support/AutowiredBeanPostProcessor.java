...
public abstract class AutowiredBeanPostProcessor implements BeanPostProcessor {
	...
	public void postProcessBeforeInitialization(Object bean, String beanName) throws BeansException {
		for (Field field : mappingFactory.getMapping(bean.getClass()).getElements()) {
	...
	protected abstract boolean canAutwired(Object bean, String beanName, Field field);

	protected abstract void autowired(Object bean, String beanName, Field field);
}
