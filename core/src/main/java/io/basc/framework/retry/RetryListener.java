...
public interface RetryListener {
	 ...
	 * {@link RetryOperations}. The whole retry can be vetoed by returning false
	 * from this method, in which case a {@link TerminatedRetryException} will
	 * be thrown.
	 * 
	 * @param <T>
	 *            the type of object returned by the callback
	 * @param context
	 *            the current {@link RetryContext}.
	 * @param callback
