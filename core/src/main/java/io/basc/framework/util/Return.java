...
public interface Return<T> extends Optional<T>, Status {
	...
	static <U> Return<U> success(long code,  String msg) {
		return success(code, msg, null);
	}

	static <U> Return<U> success(long code,  String msg,  U value) {
		return new StandardReturn<U>(true, code, msg, value);
	}

	static <U> Return<U> error( String msg) {
		return error(0, msg);
	}

	static <U> Return<U> error(String msg,  U value) {
		return error(0, msg, value);
	}

	static <U> Return<U> error(long code,  String msg) {
		return error(code, msg, null);
	}

	static <U> Return<U> error(long code,  String msg,  U value) {
