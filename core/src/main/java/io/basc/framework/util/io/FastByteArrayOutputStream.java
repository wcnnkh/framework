 ...
 *
 * <p>
 * The initial buffer is only created when the stream is first written. There is
 * also no copying of the internal buffer if its contents is extracted with the
...
public class FastByteArrayOutputStream extends OutputStream {
	...
	/**
	 * Create a new <code>FastByteArrayOutputStream</code> with the specified
	 * initial capacity.
	 * 
	 ...
	 * if the byte array is being made anyways, mind as well as use it. This
	 * approach also means that if this method is called twice without any writes in
	 * between, the second call is a no-op.
	 * <p>
	 ...
	 * <p>
	 * Its size is the current size of this output stream and the valid contents of
	 ...
	 * output stream can be used again.
	 */
	public void reset() {
		this.buffers.clear();
	 ...
	 * <p>
	 * Note that if any methods are called on the OutputStream (including, but not
	 * limited to, any of the write methods, {@link #reset()},
	 ...
	 * @throws IllegalArgumentException if the given capacity is smaller than the
	 *                                  actual size of the content stored in the
	 *                                  buffer already
	...
	private static final class FastByteArrayInputStream extends UpdateMessageDigestInputStream {
		 ...
		 * 
		 * @param messageDigest the message digest to update
		 * @param len           how many bytes to read from this stream and use to
