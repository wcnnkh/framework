...
public class WatchKeyRegistry extends ElementRegistry<WatchKey, Collection<ElementRegistration<WatchKey>>> {
	...
	public WatchKeyRegistry(int initialCapacity, @NonNull EventPublishService<ChangeEvent<WatchKey>> eventPublishService) {
	...
	@Override
	public Elements<WatchKey> getServices() {
		return super.getServices().filter((e) -> !e.isValid());
	}
}
