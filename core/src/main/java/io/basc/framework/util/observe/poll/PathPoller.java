...
import io.basc.framework.util.observe.register.EmptyPayloadRegistration;
...
public class PathPoller<T extends FileVariable> extends VariablePoller<T> {
	...
	private Listenable<? extends Receipt> publishWatchEvents(Elements<WatchEvent<Path>> watchEvents) {
