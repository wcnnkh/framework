...
public class NativeServiceLoader<S> implements io.basc.framework.util.ServiceLoader<S> {
	/**
	 ...
	 */
	public static <S> io.basc.framework.util.ServiceLoader<S> load(Class<S> service) {
	 ...
	 * @return A new service loader
	 */
	public static <S> io.basc.framework.util.ServiceLoader<S> load(Class<S> service, ClassLoader loader) {
	 ...
	 * @return A new service loader
	 */
	public static <S> io.basc.framework.util.ServiceLoader<S> loadInstalled(Class<S> service) {
