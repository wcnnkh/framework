 ...
 *
 * @author https://github.com/spring-projects/spring-framework/blob/main/spring-core/src/main/java/org/springframework/core/io/AbstractFileResolvingResource.java
 */
public abstract class AbstractFileResolvingResource extends AbstractResource {
	 ...
	 * 
	 * @see io.basc.framework.util.io.ResourceUtils#getFile(java.net.URL, String)
	 */
	@Override
	 ...
	 * resource, provided that it refers to a file in the file system.
	 * 
	 * @see io.basc.framework.util.io.ResourceUtils#getFile(java.net.URI, String)
	 */
