...
import io.basc.framework.util.io.VfsResource;
 ...
 * {@link io.basc.framework.util.io.Resource}, or alternatively may contain the
 * special "{@code classpath*:}" prefix and/or internal Ant-style regular
 * expressions (matched using
 * {@link io.basc.framework.util.match.AntPathMatcher} utility). Both of the
 ...
 * @see io.basc.framework.util.io.load.ResourceLoader#getResource(String)
...
public class PathMatchingResourcePatternResolver implements ResourcePatternResolver {
	 ...
	 * 
	 * @see io.basc.framework.util.io.load.DefaultResourceLoader
	 */
	 ...
	 * @see java.lang.ClassLoader#getResources
	 * @see io.basc.framework.util.io.Resource
	 */
	 ...
	 * @see #doFindPathMatchingJarResources
	 * @see io.basc.framework.util.io.ResourceUtils#isJarURL
	 */
