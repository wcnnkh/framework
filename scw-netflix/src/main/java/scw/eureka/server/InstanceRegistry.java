...
import scw.eureka.server.event.EurekaInstanceCanceledEvent;
import scw.eureka.server.event.EurekaInstanceRegisteredEvent;
import scw.eureka.server.event.EurekaInstanceRenewedEvent;
