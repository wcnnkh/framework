 ...
 * this serializer through {@link scw.json.gson.GsonBuilder#registerTypeAdapter(Type, Object)}.
 *
...
public interface JsonSerializer<T> {
   ...
   */
  public GsonJsonElement serialize(T src, Type typeOfSrc, JsonSerializationContext context);
}
