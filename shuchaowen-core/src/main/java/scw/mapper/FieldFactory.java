...
public abstract class FieldFactory {
	...
	public final Collection<Field> getFields(Class<?> clazz) {
	...
	public final LinkedList<FieldContext> getFieldContexts(Class<?> clazz, boolean useSuperClass, FieldContext parentContext,
	...
	public final FieldContext getFieldContext(Class<?> clazz, boolean useSuperClass, FieldContext parentContext, FieldContextFilter filter,
			FieldFilterType... fieldFilterTypes) {
		Class<?> classToUse = clazz;
		while (classToUse != null && classToUse != Object.class) {
			for (scw.mapper.Field field : getFields(classToUse)) {
	...
	public final FieldContext getFieldContext(Class<?> clazz, boolean useSuperClass, String name, FieldFilterType... fieldFilterTypes) {
		return getFieldContext(clazz, useSuperClass, name, null, fieldFilterTypes);
	}

	public final FieldContext getFieldContext(Class<?> clazz, boolean useSuperClass, final String name, FieldContext parentContext,
	...
	public final FieldContext getFieldContext(Class<?> clazz, String name,
		...
		return getFieldContext(clazz, true, name, parentContext, fieldFilterTypes);
	}
