...
public abstract class DecoratingClassLoader extends ClassLoader {
	 ...
	 * @since 4.1.2
	 */
	protected static final boolean parallelCapableClassLoaderAvailable = ReflectionUtils
			.hasAtLeastOneMethodWithName(ClassLoader.class, "registerAsParallelCapable");
	 ...
	 * <p>
	 * Any class name registered here will be handled by the parent ClassLoader
