...
abstract public class StringSwitcher {
	 ...
	 * generated instance, use a new instance of StringSwitcher.Generator
	 ...
	 *            {@link #intValue} as <code>-1</code>; if true, the result will
	 *            be undefined, and the resulting code will be faster
	 */
	...
	public static class Generator extends AbstractClassGenerator {
		 ...
		 * 
		 * @param ints
		 *            the array of integer results; must be the same length as
		 *            the key array
		 * @see #setStrings
		 */
