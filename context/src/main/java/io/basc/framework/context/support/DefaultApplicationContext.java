...
public class DefaultApplicationContext extends DefaultServiceLoaderFactory implements ConfigurableApplicationContext {
	...
	public DefaultApplicationContext(Scope scope) {
		...
		// 注册后置处理器
		applicationContextInitializers.register(new AnnotationContextPostProcessor());
	...
	public ApplicationContextInitializers getApplicationContextInitializers() {
	...
	protected void _init() {
		...
		if (!applicationContextInitializers.isConfigured()) {
			applicationContextInitializers.configure(this);
		}
