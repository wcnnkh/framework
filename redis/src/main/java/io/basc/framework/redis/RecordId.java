 ...
 * @see <a href="https://redis.io/topics/streams-intro#entry-ids">Redis
 *      Documentation - Entriy ID</a>
 */
public class RecordId {
	...
	/**
	 * Auto-generation of IDs by the server is almost always what you want so we've
	 * got this instance here shortcutting computation.
	 */
	 ...
	 * For server auto generated {@literal entry-id} on insert pass in
	 * {@literal null} or {@literal *}. Event better, just use
	 * {@link #autoGenerate()}.
	 *
	...
	/**
	 * Create a new instance of {@link RecordId} using the provided String formatted
	 * as {@literal <millisecondsTime>-<sequenceNumber>}. <br />
	 * For server auto generated {@literal entry-id} on insert use
	 * {@link #autoGenerate()}.
	 *
	...
	/**
	 * Obtain the {@link RecordId} signalling the server to auto generate an
	 * {@literal entry-id} on insert ({@code XADD}).
	 *
	 * @return {@link RecordId} instance signalling
	 *         {@link #shouldBeAutoGenerated()}.
	 */
	...
	/**
	 * Get the {@literal entry-id millisecondsTime} part or {@literal null} if it
	 * {@link #shouldBeAutoGenerated()}.
	 *
	...
	/**
	 * Get the {@literal entry-id sequenceNumber} part or {@literal null} if it
	 * {@link #shouldBeAutoGenerated()}.
	 *
	...
	/**
	 * @return {@literal true} if a new {@literal entry-id} shall be generated on
	 *         server side when calling {@code XADD}.
	 */
	public boolean shouldBeAutoGenerated() {
		return false;
	}
	 ...
	 *         {@literal <millisecondsTime>-<sequenceNumber>} format or {@literal *}
	 *         if it {@link #shouldBeAutoGenerated()}. Never {@literal null}.
	 */
