...
public interface RedisCommands<K, V> extends RedisConnectionCommands<K, V>, RedisGeoCommands<K, V>,
		...
		RedisStreamsCommands<K, V>, RedisStringCommands<K, V>, RedisSetsCommands<K, V>, RedisTransactionsCommands<K> {
}
