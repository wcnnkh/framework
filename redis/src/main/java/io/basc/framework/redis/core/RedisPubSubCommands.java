...
public interface RedisPubSubCommands<K, V> {
	...
	/**
	 * Indicates whether the current connection is subscribed (to at least one
	 * channel) or not.
	 *
	...
	/**
	 * Returns the current subscription for this connection or null if the
	 ...
	 * @return the number of clients that received the message or {@literal null}
	 *         when used in pipeline / transaction.
	 * @see <a href="https://redis.io/commands/publish">Redis Documentation:
	 *      PUBLISH</a>
	 */
	@Nullable
	...
	/**
	 * Subscribes the connection to the given channels. Once subscribed, a
	 * connection enters listening mode and can only subscribe to other channels or
	 * unsubscribe. No other commands are accepted until the connection is
	 * unsubscribed.
	 * <p>
	 ...
	 * @see <a href="https://redis.io/commands/subscribe">Redis Documentation:
	 *      SUBSCRIBE</a>
	 */
	void subscribe(MessageListener<K, V> listener, K... channels);

	/**
	 * Subscribes the connection to all channels matching the given patterns. Once
	 * subscribed, a connection enters listening mode and can only subscribe to
	 * other channels or unsubscribe. No other commands are accepted until the
	 ...
	 * @see <a href="https://redis.io/commands/psubscribe">Redis Documentation:
	 *      PSUBSCRIBE</a>
	 */
