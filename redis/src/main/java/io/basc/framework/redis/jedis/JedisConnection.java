...
import io.basc.framework.redis.core.DataType;
import io.basc.framework.redis.core.GeoRadiusArgs;
import io.basc.framework.redis.core.GeoRadiusWith;
import io.basc.framework.redis.core.GeoWithin;
import io.basc.framework.redis.core.MessageListener;
import io.basc.framework.redis.core.RedisAuth;
import io.basc.framework.redis.core.RedisConnection;
import io.basc.framework.redis.core.RedisSubscribedConnectionException;
import io.basc.framework.redis.core.RedisValueEncoding;
import io.basc.framework.redis.core.RedisValueEncodings;
...
public class JedisConnection implements RedisConnection<byte[], byte[]>, Decorator {
	...
	@Override
	public byte[] getEx(byte[] key, io.basc.framework.redis.core.RedisStringCommands.ExpireOption option, Long time) {
	...
	@Override
	public Collection<io.basc.framework.redis.core.RedisSortedSetsCommands.Tuple<byte[]>> zunionWithScores(
	...
	public List<byte[]> xclaim(byte[] key, byte[] group, byte[] consumer, long minIdleTime,
			io.basc.framework.redis.core.RedisStreamsCommands.ClaimArgs args, byte[]... ids) {
	...
	@Override
	public void scriptFlush(io.basc.framework.redis.core.RedisScriptingCommands.FlushMode flushMode) {
