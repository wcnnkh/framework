...
public class DefaultConvertibleRedisTransactionsCommands<C extends RedisTransaction<SK, SV>, SK, K, SV, V> extends
		DefaultConvertibleRedisPipelineCommands<C, SK, K, SV, V> implements ConvertibleRedisTransaction<SK, K, SV, V> {
