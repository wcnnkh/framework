...
import scw.redis.RedisScriptOperations;
...
public final class RedisUtils {
	...
	public static Long incr(RedisCommands<String, String> redisCommands, String key, long delta, long initialValue,
			int exp) {
		return redisCommands.eval(INCR_AND_INIT_SCRIPT, ReturnType.INTEGER, Arrays.asList(key),
