...
public class EurekaClientConfigBean implements EurekaClientConfig {
	 ...
	 * information. Eureka servers could be added or removed and this setting
	 * controls how soon the eureka clients should know about it.
	 */
	...
	/**
	 * Gets the URL context to be used to construct the service url to contact
	...
	/**
	 * Indicates whether the client should explicitly unregister itself from the
	 * remote server on client shutdown.
	 */
	private boolean shouldUnregisterOnShutdown = true;

	/**
	 * Indicates whether the client should enforce registration during
	...
	public List<String> getEurekaServerServiceUrls(String myZone) {
		...
		if (!StringUtils.isEmpty(serviceUrls)) {
			final String[] serviceUrlsSplit = StringUtils.splitToArray(serviceUrls);
