...
public class EurekaInstanceConfigBean implements CloudEurekaInstanceConfig {
	...
	/**
	 * Indicates whether the non-secure port should be enabled for traffic or
	 * not.
	 */
	 ...
	 * the value specified in leaseRenewalIntervalInSeconds.
	 */
	...
	/**
	 * Get the unique Id (within the scope of the appName) of this instance to
	 * be registered with eureka.
	 */
	 ...
	 * information is specifically used in an AWS environment to automatically
	 * put an instance out of service after the instance is launched and it has
	 * been disabled for traffic..
	 */
	...
	/**
	 * Gets the relative status page URL path for this instance. The status page
	 ...
	 * about the status of this instance. Users can provide a simple HTML
	 ...
	 * provide the statusPageUrlPath if the status page resides in the same
	 * instance talking to eureka, else in the cases where the instance is a
	 * proxy for some other server, users can provide the full URL. If the full
	...
	/**
	 * Gets the relative home page URL Path for this instance. The home page URL
	...
	/**
	 * Gets the absolute home page URL for this instance. The users can provide
	 * the homePageUrlPath if the home page resides in the same instance talking
	 * to eureka, else in the cases where the instance is a proxy for some other
	 * server, users can provide the full URL. If the full URL is provided it
	 * takes precedence.
	 *
	 * It is normally used for informational purposes for other services to use
	...
	/**
	 * Gets the relative health check URL path for this instance. The health
	 * check page URL is then constructed out of the hostname and the type of
	 ...
	 * provide the healthCheckUrlPath if the health check page resides in the
	 * same instance talking to eureka, else in the cases where the instance is
	 * a proxy for some other server, users can provide the full URL. If the
	 * full URL is provided it takes precedence.
	 *
	 * <p>
	 * It is normally used for making educated decisions based on the health of
	 * the instance - for example, it can be used to determine whether to
	...
	/**
	 * Gets the absolute secure health check page URL for this instance. The
	 * users can provide the secureHealthCheckUrl if the health check page
	...
	/**
	 * The hostname if it can be determined at configuration time (otherwise it
	 * will be guessed from OS primitives).
	 */
