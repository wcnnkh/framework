...
public class DefaultDatabaseConnectionFactory2 extends DefaultConnectionFactory implements DatabaseConnectionFactory {
	private final DatabaseDialect databaseDialect;
	private volatile DatabaseURL databaseURL;
	private volatile String databaseName;
	private volatile ConnectionFactory serverConnectionFactory;

	public DefaultDatabaseConnectionFactory2(String url, DatabaseDialect databaseDialect) {
		this(url, null, databaseDialect);
	}

	public DefaultDatabaseConnectionFactory2(String url, ConnectionInfo info, DatabaseDialect databaseDialect) {
		super(url, info);
	...
	public DatabaseConnectionFactory newDatabaseConnectionFactory(String databaseName) throws UnsupportedException {
		...
		DefaultDatabaseConnectionFactory2 connectionFactory = new DefaultDatabaseConnectionFactory2(
				databaseURL.getRawURL(), getInfo(), this.databaseDialect);
