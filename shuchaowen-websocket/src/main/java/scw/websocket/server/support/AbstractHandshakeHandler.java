 ...
 * {@link scw.websocket.server.RequestUpgradeStrategy}, which will update
 ...
 * @since 4.2
 * @see scw.websocket.server.jetty.JettyRequestUpgradeStrategy
 * @see scw.websocket.server.standard.TomcatRequestUpgradeStrategy
 * @see scw.websocket.server.standard.UndertowRequestUpgradeStrategy
 * @see scw.websocket.server.standard.GlassFishRequestUpgradeStrategy
 * @see scw.websocket.server.standard.WebLogicRequestUpgradeStrategy
 */
public abstract class AbstractHandshakeHandler implements HandshakeHandler {
	...
	private static RequestUpgradeStrategy initRequestUpgradeStrategy() {
		String className;
		if (tomcatWsPresent) {
			className = "scw.websocket.server.standard.TomcatRequestUpgradeStrategy";
		}
		else if (jettyWsPresent) {
			className = "scw.websocket.server.jetty.JettyRequestUpgradeStrategy";
		}
		else if (undertowWsPresent) {
			className = "scw.websocket.server.standard.UndertowRequestUpgradeStrategy";
		}
		else if (glassfishWsPresent) {
			className = "scw.websocket.server.standard.GlassFishRequestUpgradeStrategy";
		}
		else if (weblogicWsPresent) {
			className = "scw.websocket.server.standard.WebLogicRequestUpgradeStrategy";
		}
		else if (websphereWsPresent) {
			className = "scw.websocket.server.standard.WebSphereRequestUpgradeStrategy";
		}
		else {
