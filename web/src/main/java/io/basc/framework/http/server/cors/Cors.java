...
public class Cors{
	...
	public Cors setMethods(String... methods) {
		if (isReadyOnly()) {
			throw new UnsupportedOperationException("setMethods");
		}
	...
	public void setOrigins(String... origins) {
		if (isReadyOnly()) {
			throw new UnsupportedOperationException("setOrigins");
		}
	...
	public Cors setCredentials(Boolean credentials) {
		if (isReadyOnly()) {
			throw new UnsupportedOperationException("setCredentials");
		}
	...
	public Cors setMaxAge(Integer maxAge) {
		if (isReadyOnly()) {
			throw new UnsupportedOperationException("setMaxAge");
		}
