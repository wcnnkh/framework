package scw.integration.ali.oss;
...
import scw.integration.ali.oss.ObjectListing;
import scw.lang.AlreadyExistsException;
import scw.lang.NotFoundException;
import scw.lang.ParameterException;
import scw.net.http.ProtocolType;
...
public final class OSS {
	...
	public ObjectListing myListObject(String bucketName, String prefix, int limit, String nextMarker) {
		...
		return objectListing == null ? null : new scw.integration.ali.oss.ObjectListing(objectListing);
	}
