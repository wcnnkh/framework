...
public interface RetryContext extends EditableAttributes<String, Object> {
	...
	/**
	 * Counts the number of retry attempts. Before the first attempt this counter is
	 * zero, and before the first and subsequent attempts it should increment
	 * accordingly.
	 * 
	 ...
	 * 
	 * @return the last exception that caused a retry, or possibly null. It will be
	 *         null if this is the first attempt, but also if the enclosing policy
	...
	/**
	 * Signal to the framework that no more attempts should be made to try or retry
